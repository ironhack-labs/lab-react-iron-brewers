...
const AddNewBeerForm = () => {
    ...
    const handleNewBeerSubmit = e => {
        e.preventDefault()
        const newBeerData = { name: name, tagline: tagline, description: description, image_url: imageUrl, first_brewed: firstBrewed, brewers_tips: brewersTips, attenuation_level: attenuationLevel, contributed_by: contributedBy }

        axios
            .post(`${API_URL}/new`, newBeerData)
            .then(() => {
                navigate('/beers')
            })
