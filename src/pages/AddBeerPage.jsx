...
function AddBeerPage() {
  ...
  const handleBeerSubmit = (e) => {
    e.preventDefault()
    const beerData = {
      name: name, tagline: tagline, description: description, imageUrl: imageUrl, firstBrewed: firstBrewed,
      brewersTips: brewersTips, attenuationLevel: attenuationLevel, contributedBy: contributedBy
    }

    axios
      .post(`${API_URL}/new`, beerData)
      .then(() => {
