...
function AddBeerPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const requestBody = { name, tagline, description, image_url: imageUrl, first_brewed: firstBrewed, brewers_tips: brewersTips, attenuation_level: parseInt(attenuationLevel), contributed_by: contributedBy};
