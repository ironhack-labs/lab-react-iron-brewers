...
function AddBeerPage() {
  ...
  const handleOnSubmitForm = e => {
    ...
    const beersData = {
      ...
      imageUrl: imageUrl, firstBrewed: firstBrewed, brewersTips: brewersTips,
      attenuationLevel: attenuationLevel, contributedBy: contributedBy
    }
    axios
      .post(`${API_URL}/new`, beersData)
      .then(() => alert("we did it"))
