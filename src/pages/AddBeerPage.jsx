...
const handleSubmit = (e) => {
  ...
  // preparar un objeto (e.g. newBeeer) con los datos que queremos mandar a la api
  ...
  const newBeer = {
    ...
    contribuited: contributedBy,
  }
  // enviar la petición http: axios.post(url, data)

  axios.post(`https://beers-api.edu.ironhack.com/beers/new`, newBeer)
    .then(() => {
      navigate("/beers")
    }).catch((e) => {
      console.log("error to create new beer", e);
    })
} 
