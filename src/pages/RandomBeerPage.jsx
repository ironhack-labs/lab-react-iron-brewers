...
function RandomBeersPage() {
  ...
  useEffect(()=>{
    ...
    // .then((beersData)=>{
    //   const randomNumber = Math.floor(Math.random() * beersData.length)
    //   const randomBeerId = beersData[randomNumber]._id;
    //   axios.get(`https://ih-beers-api2.herokuapp.com/beers/${randomBeerId}`)
    //   .then((randomBeerResponse)=>{
